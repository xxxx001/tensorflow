...
static mutext executor_factory_lock(LINKER_INITIALIZED);
...
Status NewExecutor(const string & executor_type ,
				   ...
				   TF_RETURN_IF_ERROR(ExecutorFactory::GetFactory(executor_type,&fatory));
