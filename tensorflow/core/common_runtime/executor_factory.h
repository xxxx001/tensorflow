/* Copyright 2015 The TensorFlow Authors . All Rights Reserved .
   Licensed under the Apache Liense , Version 2.0 (the "License")
   you may not use this file except in compliance with the License.
   you may ottain a copy of the License at 
...
class ExecutorFactory {
	public :
		...
		static Status GetFactory(const string& executor_type , ExecutorFactory **out_factory);
